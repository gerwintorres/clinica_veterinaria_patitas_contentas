...
<main class="formulario-cerrado contenedor margen-inferior-config">
    <div class="form-grupo-cerrado-4 margen-superior">
        <div>
            ...
            <input type="text" class="input-cerrado" id="nombres" name="nombres" disabled>
        </div>
        <div>
            <label for="direccion">Dirección</label>
            <input type="text" class="input-cerrado" id="direccion" name="direccion" disabled>
        </div> 
    </div>
    <div class="form-grupo-cerrado-2 margen-superior-config">
        <div>
            <label for="apellidos">Apellidos</label>
            <input type="text" class="input-cerrado input-width" id="apellidos" name="apellidos" disabled>
        </div>
        <div></div>
        <div>
            <label for="tipoDocumento">Tipo de documento</label>
            <input type="text" class="input-cerrado" id="tipoDocumento" name="tipoDocumento" disabled>
        </div>
        <div>
            <label for="numeroDocumento">Numero de documento</label>
            <input type="int" class="input-cerrado" id="numeroDocumento" name="numeroDocumento" disabled>
        </div>
    </div>
