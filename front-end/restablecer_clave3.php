...
<div class="contenedor contenedor-boton-atras">
    <a href="restablecer_clave2.php" class="boton-atras"> <svg width="11" height="20" viewBox="0 0 11 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="form-contenido">
        <form action="" method="POST">
            ...
            <div class="contenido-centrado ">
                <input class="boton-formulario-azul margen-superior margen-inferior" type="submit" value="CAMBIAR CONTRASEÑA">
            </div>
        </form>
    </div>
</main>
