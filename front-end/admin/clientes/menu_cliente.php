...
?>
<h1 class="contenedor titulo-h1-pagina alineacion-izquierda" id="mensaje-bienvenida">PERFIL, <?php echo $nombres?></h1>
<main class="contenedor main-inicio-sesion">
    <a class="card" href="mascotas/mis_mascotas.php">mascotas
