...
<main class="formulario-iniciar-sesion contenedor-interior">
    <div class="formulario-iniciar-sesion-izq fondo-inicio-sesion-admin">
        <h4>Clínica Veterinaria Patitas Contentas</h4>
        <p>¡Saludos, Administrador! Por favor inicie sesión para acceder al panel de administración. Gracias por su labor en mantener nuestro sistema en funcionamiento para garantizar un servicio eficiente y de calidad para nuestras operaciones veterinarias.</p>
        <img src="./build/img/patitas.webp" alt="">
    </div>
    <form action="" class="formulario-iniciar-sesion-der">
