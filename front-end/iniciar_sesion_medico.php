...
<main class="formulario-iniciar-sesion contenedor-interior">
    <div class="formulario-iniciar-sesion-izq fondo-inicio-sesion-medico">
        <h4>Clínica Veterinaria Patitas Contentas</h4>
        <p>¡Bienvenido de nuevo, Dr! Por favor inicia sesión para acceder a nuestros servicios veterinarios. Agradecemos tu dedicación y compromiso con el cuidado de nuestras mascotas.</p>
